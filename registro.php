<?php require('./layout/header.php') ?>
    ...
    <main>
        <section class="section_registro">
            <form class="container_formulario_registro" action="#">
                <div class="content_formulario_registro">
                    <div class="registro_lado_izquierdo">
                        ...
                        <input class="direccion" type="text" require="" placeholder="Dirección">
                    </div>
                    <div class="registro_lado_derecho">
                        ...
                        <input class="numero_de_documento" type="number" require="" placeholder="Número de documento">
